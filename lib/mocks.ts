...
export const mockValidators: Validator[] = [
  {
    ...
    lastRationale:
      "AI has the potential to solve many global challenges and improve human life in numerous ways.",
    modelName: "GPT-4o",
    description:
  ...
  },
  {
    ...
    lastResponse: "Consensus reached",
    lastRationale:
      "With proper regulation and ethical guidelines, AI can benefit humanity significantly.",
  ...
  },
  {
    ...
    lastResponse: "Consensus reached",
    lastRationale:
      "AI technologies are already helping in healthcare, education, and environmental protection.",
  ...
  },
  {
    ...
    lastResponse: "Consensus reached",
    lastRationale:
      "The risks of job displacement and uncontrolled AI development outweigh the benefits.",
  ...
  },
  {
    ...
    lastResponse: "Consensus reached",
    lastRationale:
      "When developed responsibly, AI can lead to tremendous scientific and social progress.",
