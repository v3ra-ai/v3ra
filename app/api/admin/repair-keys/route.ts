...
// if (!ENCRYPTION_KEY || ENCRYPTION_KEY === "verafy-default-encryption-key-32chars") {
//   throw new Error("ENCRYPTION_KEY must be set to a secure value in production");
// }
// if (!ENCRYPTION_IV || ENCRYPTION_IV === "verafy-default-iv") {
//   throw new Error("ENCRYPTION_IV must be set to a secure value in production");
// }
