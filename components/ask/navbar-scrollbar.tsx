...
import { QUERY_COST, INITIAL_AVAILABLE_QUERIES, ALLOWED_AMOUNT_QUERIES } from "@/lib/constants";
...
export function NavbarScrollbar({ mounted, showSearch }: NavbarScrollbarProps) {
  ...
  const { userAiQueryAmountRequested, totalQueries, queryMode, setUserAiQueryAmountRequested } = useQueryStore();
  console.log(`userAiQueryAmountRequested ${userAiQueryAmountRequested})`)
      ...
      <div className="flex flex-col md:flex-row md:items-center md:space-x-2">
        ...
        <div className="flex flex-row md:w-2/3 items-center h-full md:text-left flex-wrap gap-2">
          <QueryFormAISlider
            ...
            handleQueryAmountChange={setUserAiQueryAmountRequested}
