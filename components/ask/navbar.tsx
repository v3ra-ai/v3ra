    ...
    <div className="w-full">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Button className="bg-teal-500 hover:bg-teal-600 text-white rounded-full px-4 py-2">
            Connect to Wallet
          </Button>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 flex justify-center mt-2">
        <div className="inline-flex items-center bg-gray-100 rounded-full p-1">
          <button
            ...
            className={`px-4 py-1 rounded-full text-sm cursor-pointer ${mode === "standard" ? "bg-white shadow-sm text-gray-500" : "text-gray-500"}`}
          >
            Standard
          </button>
          <button
            onClick={() => setMode("expert")}
            className={`px-4 py-1 rounded-full text-sm cursor-pointer ${mode === "expert" ? "bg-white shadow-sm text-gray-500" : "text-gray-500"}`}
          >
            Expert
          </button>
        </div>
