...
> {
  ...
  constructor(props: KeyManagerProps) {
    ...
    this.handleProviderFilterChange =
      this.handleProviderFilterChange.bind(this);
        ...
        <div className="bg-gray-100 rounded-xl shadow-xl w-full max-w-3xl p-6 max-h-[90vh] overflow-auto">
          ...
          <div className="mb-6">
            <p className="text-gray-600 mb-2">
              API keys are stored securely on the server and never exposed to
              clients. Use key references when adding validators instead of raw
              API keys.
            </p>
                ...
                {loading && !filteredKeys.length ? (
                  ...
                  <tr>
                    ...
                    >
                      ...
                      {!providerFilter
                        ? ""
                        : "Try changing the provider filter."}
                    </td>
                  </tr>
                ) : (
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            <div className="flex justify-between items-center">
              <p className="text-xs text-gray-500">
                API keys are securely stored on the server and never exposed in
                responses.
              </p>
              <button
                onClick={this.handleClose}
